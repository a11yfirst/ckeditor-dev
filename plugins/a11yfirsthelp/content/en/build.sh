...
# 1. Escape all embedded single quote characters with backslash character
# 2. At the beginning of each line: add single quote character
# 3. At the end of each line: add newline, single quote and plus (concatenation) characters
